...
export function AnimeNavBar({ items, className, defaultActive = "Home" }: NavBarProps) {
  ...
  return (
    <div className="fixed top-9 right-0 z-[9999]">
      <div className="flex justify-end pr-8 pt-6">
        ...
        >
          ...
          <Link
            href="/sign-in"
            className="relative cursor-pointer text-sm font-semibold px-6 py-2 rounded-full transition-all duration-300 text-black bg-amber-400 hover:bg-amber-300"
          >
            Sign In
          </Link>
        </motion.div>
